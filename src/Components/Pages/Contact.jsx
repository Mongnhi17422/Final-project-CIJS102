...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("https://script.google.com/macros/s/AKfycbxQjyun3o6KoAVzCJ5ZHsw1nPR7zURgyLb9sUkcNWXEtnf1jK91p8JhGs-Jh2GrzNye/exec", {
      method: "POST",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row g-3">
                ...
                <div className="col-12">
                  <div className="form-floating">
                    <input type="number" className="form-control" id="phone" name="phone" placeholder="Mobile No" required />
                    <label htmlFor="subject">Phone</label>
                  </div>
                </div>
                <div className="col-12">
                  <div className="form-floating">
                    <textarea className="form-control" placeholder="Leave a message here" id="message" name="message" style={{ height: "150px" }} defaultValue={""} />
                    <label htmlFor="message">Message</label>
                  </div>
                </div>
                <input type="hidden" name="subject" value="New Submission from contact page"></input>
                <div className="col-8">
                  <HCaptcha
